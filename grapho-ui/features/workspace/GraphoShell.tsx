...
export default function GraphoShell() {
  ...
  useEffect(() => {
    const startCanvasSelection = (event: MouseEvent) => {
      ...
      const wrapper = margin?.closest<HTMLElement>("div.group") ?? target.closest<HTMLElement>("div.group");
